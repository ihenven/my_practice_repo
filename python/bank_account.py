...
class BankAccount:
    # def __init__ method is like the constructor in Java
    # instance variales declared in the __init__ method are global and MUST
    # be refereced using self
    # self is like 'this' in Java
    def __init__(self, account_number, balance=0.0):
        self.account_number = account_number   # "similar to this. in java"
        self.balance = balance

    # def __str__ is like the toString() method in Java
    ...
    def deposit(self, amount):
        self.balance += amount   #first parameter has to be "self"
